...
st.title("自定沖銷設定")
st.caption("可指定「某筆賣出」與「某筆買進」的沖銷股數；在 Portfolio、投資績效、個股明細等頁面選擇「自定沖銷」時會依此規則計算損益。")
...
st.subheader("使用說明")
st.markdown("""
- **自定沖銷**：在此頁設定「賣出 A 的 X 股」與「買進 B 的 X 股」配對；在 **Portfolio 持倉與損益**、**投資績效（含損益總覽）**、**個股明細**、**日成交明細** 等頁面將「損益沖銷方式」選為 **自定沖銷** 時，會依此規則計算已實現損益。
